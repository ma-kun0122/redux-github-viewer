...
const HeaderMenus = () => {
  ...
  //useEffectの解説記事https://qiita.com/penpenta/items/08ac84ae4991c6625eea
    ...
    return (
      ...
      { isOpen &&
      <Menu>
        <MenuUL onBlur={() => setTimeout(() => setIsOpen(false), 100)} //onBlur解説https://ja.reactjs.org/docs/events.html
          ref={menuRef}
          tabIndex={1}>
            <MenuList><StyledLink to="/Home"> Top</StyledLink></MenuList>
            <MenuList><StyledLink to="/profile">Your Profile</StyledLink></MenuList>
            <MenuList><StyledLink to="/issue">Issue</StyledLink></MenuList>
            <MenuList><StyledLink to="/pull-request">PullRequest</StyledLink></MenuList>
        </MenuUL>
      </Menu>
      }

        {/* 条件付きレンダーの公式ドキュメント　https://ja.reactjs.org/docs/conditional-rendering.html */}
